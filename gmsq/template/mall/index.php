...
<div class="header">
    ...
    margin-left: 5px;" href="//wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq']?>&site=qq&menu=yes" target="_blank">联系客服</a></font>
		...
		<div class="topcon fr">
			<span class="login_top_wrap fl">
				...
				<a href="./user/regsite.php" target="_blank" class="green">自助开通分站</a>
	...
	<div class="nav widthset">
		...
		<a onclick='location.href="./user/regsite.php";' target="_blank" rel="nofollow">分站搭建</a>
		...
		<div class="main_right fr">
			<div class="login_neck_wrap">
				<div class="login nologin">
					<a href="./user/regsite.php" class="btn" target="_blank">&nbsp;搭建分站</a>
