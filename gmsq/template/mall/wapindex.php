...
if(isset($_GET['cid'])){
	include_once TEMPLATE_ROOT.'mall/PostProduct.php';exit;
}
?>
<!doctype html>
<html>
...
<!-- 公共元素 开始 -->
<link href="<?php echo $cdnpublic?>mui/3.7.1/css/mui.min.css" rel="stylesheet" />
...
<script src="<?php echo $cdnpublic?>mui/3.7.1/js/mui.min.js"></script>
...
var advert4list = [{title:"",img:"<?php echo $config['banner1']?>",link:"/?mod=product"},{title:"",img:"<?php echo $config['banner2']?>",link:"/?mod=product"},{title:"",img:"<?php echo $config['banner3']?>",link:"/?mod=product"},{title:"",img:"<?php echo $config['banner4']?>",link:"/?mod=product"}];
						...
						<div class="index_menu">
							...
							<a href="./user/regsite.php" target="_blank"><img src="<?php echo $cdnserver?>assets/mall/images/menu2.png" /><span></span>搭建分站</a>
							<a href="./user/" target="_blank"><img src="<?php echo $cdnserver?>assets/mall/images/menu3.png" /><span></span>后台登录</a>
