...
$outcome_today=$DB->count("SELECT sum(point) FROM shua_points WHERE zid='{$userrow['zid']}' AND action='消费' AND addtime>'$thtime'");
$income_lastday=$DB->count("SELECT sum(point) FROM shua_points WHERE zid='{$userrow['zid']}' AND action='提成' AND addtime<'$thtime' AND addtime>'$lastday'");
$outcome_lastday=$DB->count("SELECT sum(point) FROM shua_points WHERE zid='{$userrow['zid']}' AND action='消费' AND addtime<'$thtime' AND addtime>'$lastday'");
?>
